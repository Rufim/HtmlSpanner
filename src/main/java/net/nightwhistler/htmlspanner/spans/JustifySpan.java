...
import static net.nightwhistler.htmlspanner.spans.JustifySpan.Mode.ALL_CHARACTERS;
import static net.nightwhistler.htmlspanner.spans.JustifySpan.Mode.WHITESPACE_ONLY;
